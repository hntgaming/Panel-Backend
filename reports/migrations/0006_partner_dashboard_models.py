    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['sub_publisher', '-date'], name='report_sub__sub_pub_07a794_idx'), models.Index(fields=['partner_admin', '-date'], name='report_sub__partner_b64fe4_idx'), models.Index(fields=['date'], name='report_sub__date_f98a66_idx')],
