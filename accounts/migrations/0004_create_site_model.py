    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gam_status', models.CharField(choices=[('ready', 'Ready'), ('getting_ready', 'Getting ready'), ('requires_review', 'Requires review'), ('needs_attention', 'Needs attention')], default='getting_ready', help_text='Status of site in GAM', max_length=20)),
                ('gam_site_id', models.CharField(blank=True, help_text='GAM Site ID if added to GAM', max_length=50, null=True)),
                ('ads_txt_status', models.CharField(choices=[('added', 'Added'), ('missing', 'Missing')], default='missing', help_text='Status of ads.txt', max_length=20)),
